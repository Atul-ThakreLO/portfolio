...
const Projects = ({ mainDivRef }: ProjectsProps) => {
  ...
  return (
    <section ref={projectSectionRef} className="relative mt-5 mb-52 md:mb-10 md:mt-72 pb-28">
      ...
      <div
        className="absolute top-96 left-20 w-96 h-96 bg-chart-5/4 rounded-full blur-3xl animate-pulse pointer-events-none"
